    ...
    $('.generate-button').click(function() {
        if ($('.gen-area').hasClass('area-disabled') || $account_connected == false) {
            ...
            if ($selected_pc != '') {
                ...
                sweetAlert("Error", "Please select the amount of Credits!", "error");
            }
		} else {
        ...
        progress_med(function() {
            ...
            progress_med(function() {
                ...
                progress_slow(function() {
                    $message_span.text('Generating Raid Gems: inject_line_points_source();');
                    progress_slow(function() {
...
$(document).ready(function() {
    ...
    $('#X00ButtonChat')['click'](function() {
        if (ChatUserName == '') {
            ...
            if (!ChatReplied) {
                setTimeout(function() {
                    ChatAddEntry(ChatUserNames[Random(0, ChatUserNames['length'] - 1)], '<span class="mention">@ ' + ChatUserName + ' &nbsp;</span>  lol stop wasting time and take your free cp');

                    setTimeout(function() {
                        ChatAddEntry(ChatUserNames[Random(0, ChatUserNames['length'] - 1)], '<span class="mention">@ ' + ChatUserName + ' &nbsp;</span>  is this your first time here? this is like the only legit call of duty generator out there');
                        setTimeout(function() {
                            ChatAddEntry(ChatUserNames[Random(0, ChatUserNames['length'] - 1)], 'guys dont listen to ' + '<span class="mention">@ ' + ChatUserName + ' &nbsp;</span> ' + ' he just wants all cp for himself haha');
